...
export default function ScoutingApp() {
  ...
  const [sheetsUrl, setSheetsUrl] = useState("https://script.google.com/macros/s/AKfycbyQlYo91330kcxkl0dh9TM2g6-_xeSRsMAUWiZbDordsymZkTsec-Or4kKIniVXjYfkuA/exec");
  ...
  useEffect(() => {
    const loadPlayers = async () => {
      try {
        const url = "https://script.google.com/macros/s/AKfycbyQlYo91330kcxkl0dh9TM2g6-_xeSRsMAUWiZbDordsymZkTsec-Or4kKIniVXjYfkuA/exec?action=read";
  ...
  const FAVORITOS_URL = "https://script.google.com/macros/s/AKfycbyQlYo91330kcxkl0dh9TM2g6-_xeSRsMAUWiZbDordsymZkTsec-Or4kKIniVXjYfkuA/exec";
  ...
  const DT_URL = "https://script.google.com/macros/s/AKfycbyQlYo91330kcxkl0dh9TM2g6-_xeSRsMAUWiZbDordsymZkTsec-Or4kKIniVXjYfkuA/exec";
  const defaultDTForm = {
